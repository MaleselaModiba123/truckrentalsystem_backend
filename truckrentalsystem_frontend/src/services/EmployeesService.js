...
const REST_API_BASE_URL = "http://localhost:8080/truckrentalsystem/manager";

export const getEmployees = () => axios.get(`${REST_API_BASE_URL}/getAll`);
...
export const updateEmployee = (employeeNumber, employee) => axios.post(`${REST_API_BASE_URL}/update`, employee);
